              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-group">
                    <div class="plan">
                      <div class="">
                        <input type="radio" <?php if (isset($_GET['plan']) && $_GET['plan'] == "1") {
                                              echo "checked";
                                            } ?> name="plan" value="BIZコネクト WITH FC プランS"> プランS(4,800円/月)

                      </div>
                      <div class="">
                        <input type="radio" <?php if (isset($_GET['plan']) && $_GET['plan'] == "2") {
                                              echo "checked";
                                            } ?> name="plan" value="BIZコネクト WITH FC プランM"> プランM(8,400円/月)
                      </div>
                      <div class="">
                        <input type="radio" <?php if (isset($_GET['plan']) && $_GET['plan'] == "3") {
                                              echo "checked";
