    ...
    <div class="container">
        <div class="row">
            <div class="d-flex justify-content-center align-items-center col-12">
                <img src="./images/email-sent.png" alt="email-sent">
            </div>
            <div class="d-flex flex-column mt-4 justify-content-center align-items-center col-12">
                <h3>メッセージを送信しました。</h3>
                <h4>担当者よりご連絡いたしますので、いま暫くお待ちください。</h4>
                <h3 class="mt-2"><strong>THANK YOU!</strong></h3>
                <h4>Your message was successfully sent. We will contact you as soon as possible.</h4>
